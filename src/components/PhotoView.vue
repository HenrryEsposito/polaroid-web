<template>
  <div id="photo__view">
    <div id="photo__paper" :class="animate ? 'photo__drop' : ''">
      <div id="photo__frame">
        <div :id="'css__texture__' + cssTexture" />
      </div>
    </div>
    <div id="inner__shadow" />
  </div>
</template>
<script>
export default {
...
#inner__shadow {
  ...
  box-shadow: 0 0 20pt 5pt rgb(20, 20, 20);
}
#photo__paper {
  height: 420px;
  width: 350px;
